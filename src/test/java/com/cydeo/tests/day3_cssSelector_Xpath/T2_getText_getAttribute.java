...
public class T2_getText_getAttribute {
   ...
   //     1- Open a chrome browser
        ...
        // this syntex is in our utilities folder
     ...
     //   2- Go to: https://login1.nextbasecrm.com/
        ...
        System.out.println(actualRememberMeLabel.equals(expectedRememberMeLabel)? "Label verification Passed !" : "Label verification Failed !!");
